...
public class DownloadFileDao extends BaseContentDbDao {
    ...
    public DownloadFileDao(SQLiteOpenHelper dbHelper) {
        super(dbHelper, BaseContentDbHelper.DownloadFileInfo.Table.TABLE_NAME_OF_DOWNLOAD_FILE, BaseContentDbHelper.DownloadFileInfo.Table
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(BaseContentDbHelper.DownloadFileInfo.Table.getCreateTableSql());
    }
    ...
    private void updateVersion1To2(SQLiteDatabase db) {
        db.execSQL(BaseContentDbHelper.DownloadFileInfo.Table.getUpdateTableVersion1To2Sql());
    }

    // version 2 to 3
    private void updateVersion2To3(SQLiteDatabase db) {
        db.execSQL(BaseContentDbHelper.DownloadFileInfo.Table.getUpdateTableVersion2To3Sql());
    }
