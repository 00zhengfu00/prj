...
public final class FileDownloadManager {
     ...
     */
    @Deprecated
    public void detect(String url,String videoId, OnDetectUrlFileListener onDetectUrlFileListener) {
        getDownloadTaskManager().detect(url, videoId,onDetectUrlFileListener, null);
    }
     ...
     */
    public void detect(String url, String videoId,OnDetectBigUrlFileListener onDetectBigUrlFileListener) {
        detect(url, videoId,onDetectBigUrlFileListener, null);
    }
     ...
     * @since 0.2.0
     */
    public void start(String url,String videoId) {
        getDownloadTaskManager().start(url,videoId, null);
    }
     ...
     */
    @Deprecated
    public void start(String url,String videoId, OnFileDownloadStatusListener onFileDownloadStatusListener) {
     ...
     * @since 0.2.0
     */
    public void start(List<String> urls,String videoId) {
        getDownloadTaskManager().start(urls, videoId,null);
    }
     ...
     * @param urls                         file urls
     * @param onFileDownloadStatusListener OnFileDownloadStatusListener impl
     * @deprecated use {@link #start(List,int)} instead
     */
    @Deprecated
    public void start(List<String> urls, String videoId,OnFileDownloadStatusListener onFileDownloadStatusListener) {
    ...
    public void restartAll() {
        getDownloadTaskManager().restartAll(null);
    }
    // --------------------------------------restart downloads--------------------------------------
     ...
     * @since 0.2.0
     */
    public void reStart(String url,String videoId) {
        getDownloadTaskManager().reStart(url, videoId,null);
    }
     ...
     */
    @Deprecated
    public void reStart(String url, String videoId,OnFileDownloadStatusListener onFileDownloadStatusListener) {
     ...
     * @since 0.2.0
     */
    public void reStart(List<String> urls,String videoId) {
        getDownloadTaskManager().reStart(urls,videoId, null);
    }
     ...
     */
    @Deprecated
    public void reStart(List<String> urls, String videoId,OnFileDownloadStatusListener onFileDownloadStatusListener) {
     ...
     * @since 0.3.2
     */
    void detect(String url, String videoId,OnDetectBigUrlFileListener onDetectBigUrlFileListener, DownloadConfiguration
            downloadConfiguration) {
        getDownloadTaskManager().detect(url, videoId,onDetectBigUrlFileListener, downloadConfiguration);
    }
     ...
     * @since 0.3.2
     */
    void start(String url, String videoId,DownloadConfiguration downloadConfiguration) {
        getDownloadTaskManager().start(url, videoId,downloadConfiguration);
    }
     ...
     * @since 0.3.2
     */
    void start(List<String> urls, String videoId,DownloadConfiguration downloadConfiguration) {
        getDownloadTaskManager().start(urls, videoId,downloadConfiguration);
    }
     ...
     * @since 0.3.2
     */
    void reStart(String url, String videoId,DownloadConfiguration downloadConfiguration) {
        getDownloadTaskManager().reStart(url, videoId,downloadConfiguration);
    }
     ...
     * @since 0.3.2
     */
    void reStart(List<String> urls, String videoId,DownloadConfiguration downloadConfiguration) {
        getDownloadTaskManager().reStart(urls, videoId,downloadConfiguration);
