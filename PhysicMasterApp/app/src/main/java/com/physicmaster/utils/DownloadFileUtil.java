...
import com.physicmaster.modules.videoplay.cache.bean.BaseUrlFileInfo;
import com.physicmaster.modules.videoplay.cache.db.BaseContentDbHelper;
import com.physicmaster.modules.videoplay.cache.intface.Record;
...
public class DownloadFileUtil {
     ...
     */
    public static boolean isDownloadingStatus(BaseContentDbHelper.DownloadFileInfo downloadFileInfo) {
     ...
     */
    public static boolean canDelete(BaseContentDbHelper.DownloadFileInfo downloadFileInfo) {
     ...
     */
    public static boolean canMove(BaseContentDbHelper.DownloadFileInfo downloadFileInfo) {
     ...
     */
    public static boolean canRename(BaseContentDbHelper.DownloadFileInfo downloadFileInfo) {
     ...
     */
    public static boolean isCompleted(BaseContentDbHelper.DownloadFileInfo downloadFileInfo) {
     ...
     */
    public static boolean isTempFileExist(BaseContentDbHelper.DownloadFileInfo downloadFileInfo) {
     ...
     */
    public static boolean tryToRenameTempFileToSaveFile(BaseContentDbHelper.DownloadFileInfo downloadFileInfo) {
     ...
     * @param downloadFileInfo download file
     */
    public static void recoveryExceptionStatus(Record record, BaseContentDbHelper.DownloadFileInfo downloadFileInfo) {
