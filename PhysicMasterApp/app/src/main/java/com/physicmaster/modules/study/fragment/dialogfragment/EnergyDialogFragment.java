 ...
 */
public class EnergyDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle
        ...
        mView = inflater.inflate(R.layout.dialog_fragment_energy, null);
    ...
    private void refreshUi() {
        ...
        if (propList.size() > 0 && !TextUtils.isEmpty(propList.get(0).propImg)) {
            Glide.with(mContext).load(propList.get(0).propImg).into(ivFreeEnergy);
        }
        if (propList.size() > 1 && !TextUtils.isEmpty(propList.get(1).propImg)) {
            Glide.with(mContext).load(propList.get(1).propImg).into(ivShow5);
        }
        if (propList.size() > 2 && !TextUtils.isEmpty(propList.get(2).propImg)) {
        ...
        if (TextUtils.isEmpty(userGameEnergy.recoverFullTime)) {
            ...
            tvTime.setText(userGameEnergy.recoverFullTime + "后恢复至" + userGameEnergy.maxEnergyValue + "精力");
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.btn_shop_30:
                ...
                ft2.remove(EnergyDialogFragment.this);
            ...
            case R.id.btn_shop_5:
                ...
                ft1.remove(EnergyDialogFragment.this);
            ...
            case R.id.btn_free:
                ...
                ft.remove(EnergyDialogFragment.this);
