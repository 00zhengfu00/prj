...
public class BindWeixinDialog extends Dialog implements DialogInterface.OnDismissListener {
    ...
    private Logger logger = AndroidLogger.getLogger(BindWeixinDialog.class);
    ...
    public BindWeixinDialog(Context context, OnLoginSuccessListener listener, Map<String, String>
            params) {
    ...
    public BindWeixinDialog(Context context, int themeResId) {
        super(context, themeResId);
        mContext = context;
        init();
    }

    protected BindWeixinDialog(Context context, boolean cancelable, OnCancelListener
            cancelListener) {
                ...
                if (null != document) {
                    ...
                    if (null != qrElement) {
                        ...
                        ((Activity) getContext()).runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Glide.with(getContext().getApplicationContext()).load(qrImgUrl).placeholder(R.mipmap
                                        .loading)
