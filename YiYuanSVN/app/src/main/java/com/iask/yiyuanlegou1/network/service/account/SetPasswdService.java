/* 
 * 系统名称：lswuyou
 * 类  名  称：SetPasswdService.java
 * 软件版权：无届网络科技有限公司
 * 系统版本：1.0.0
 * 开发人员： huashigen
 * 开发时间： 2015-9-27 下午4:24:37
 * 功能说明： 用户第一次设置密码
 * 审核人员：
 * 相关文档
...
public class SetPasswdService extends OpenApiDataServiceBase {

	public SetPasswdService(Context pContext) {
		super(pContext);
	}

	@Override
	protected String getResouceURI() {
		return ServiceURL.SET_PASSWORD;
	}
