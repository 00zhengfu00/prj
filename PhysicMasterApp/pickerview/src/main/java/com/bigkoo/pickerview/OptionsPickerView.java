...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    private LinearLayout lv_top_bar;
...
//        if (customListener == null) {
        ...
        lv_top_bar = (LinearLayout) findViewById(R.id.lv_topbar);
...
//            lv_top_bar.setBackgroundColor(Color_Background_Title == 0 ? pickerview_bg_topbar : Color_Background_Title);
...
//        }
    ...
    public int[] getPickerView() {
        int[] location = new int[2];
        btnSubmit.getLocationOnScreen(location);
        location[1] += btnSubmit.getHeight();
        return location;
    }
}
