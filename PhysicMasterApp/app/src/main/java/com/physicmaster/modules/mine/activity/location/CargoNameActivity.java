...
public class CargoNameActivity extends BaseActivity {
    ...
    private void chageName() {
        ...
        UIUtils.showToast(CargoNameActivity.this, "修改成功");
        CacheManager.saveString(CacheManager.TYPE_USER_INFO, CacheKeys.USER_NAME, mName);
    ...
    protected int getContentLayout() {
        return R.layout.activity_cargo_name;
    }
}
