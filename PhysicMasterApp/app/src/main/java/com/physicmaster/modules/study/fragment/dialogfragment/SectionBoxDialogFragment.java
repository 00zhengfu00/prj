...
public class SectionBoxDialogFragment extends DialogFragment {
    private View mView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle
        ...
        mView = inflater.inflate(R.layout.dialog_fragment_box_section, container, false);
        ...
        ivClose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                SectionBoxDialogFragment.this.dismiss();
            }
        });
        ...
        GetChapterDetailsResponse.DataBean.ProgressCompletionBean.ProgressListBean data = getArguments().getParcelable("data");
