...
import me.iwf.photopicker.widget.TitleBuilder;
...
public class PhotoPagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (pagerFragment == null) {
            pagerFragment =
                    (ImagePagerFragment) getSupportFragmentManager().findFragmentById(R.id
                            .photoPagerFragment);
        }
...
//    }
        ...
        titleBuilder.setLeftImageRes(R.drawable.fanhui).setLeftText("返回")
                ...
                .setMiddleTitleText("1/" + pagerFragment.getPaths().size()).setRightText("删除")
                .setRightTextOrImageListener(new View
                .OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                Snackbar snackbar = Snackbar.make(pagerFragment.getView(), R.string
                                .__picker_deleted_a_photo,
                ...
                if (pagerFragment.getPaths().size() <= 1) {
                    ...
                    new AlertDialog.Builder(PhotoPagerActivity.this)
                            ...
                            .setPositiveButton(R.string.__picker_yes, new DialogInterface
                                    .OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    dialogInterface.dismiss();
                                    pagerFragment.getPaths().remove(index);
                                    pagerFragment.getViewPager().getAdapter()
                                            .notifyDataSetChanged();
                                    onBackPressed();
                                }
                            })
                            .setNegativeButton(R.string.__picker_cancel, new DialogInterface
                                    .OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    dialogInterface.dismiss();
        ...
        pagerFragment.getViewPager().addOnPageChangeListener(new ViewPager
...
//    if (actionBar != null) actionBar.setTitle();
        titleBuilder.setMiddleTitleText(getString(R.string.__picker_image_index, pagerFragment
