...
public class CardScaleHelper {
    ...
    public void attachToRecyclerView(final RecyclerView mRecyclerView) {
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                LogUtils.v(String.format("dx=%s, dy=%s, mScrolledX=%s", dx, dy,
                        mCurrentItemOffset));
    ...
    private void computeCurrentItemPos() {
        ...
        if (pageChanged) {
            ...
            LogUtils.d(String.format("=======onCurrentItemPos Changed======= tempPos=%s, " +
                    "mCurrentItemPos=%s", tempPos, mCurrentItemPos));
        }
    }
