package com.iask.yiyuanlegou1.widget.circleview;
...
public class CycleViewPager extends BaseFragment implements OnPageChangeListener {
     ...
     */
    public void setData(List<ImageView> views, List<ADInfo> list, ImageCycleViewListener
            listener, int showPosition) {
            ...
            if (mImageCycleViewListener != null) {
                v.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        mImageCycleViewListener.onImageClick(infos.get(currentPosition - 1),
                                currentPosition, v);
                    }
                });
            }
