 ...
 */
package com.iask.yiyuanlegou1.common.cache;
...
public class CacheManager {
    ...
    public static boolean initAccountDataCache() {
        if (accountDataCache == null) {
            UserInfo info = (UserInfo) getObject(TYPE_USER_INFO, CacheKeys.USERINFO_LOGINVO,
                    UserInfo.class);
            if (info != null) {
                accountRelatedDataDirectory = info.getMobile();
