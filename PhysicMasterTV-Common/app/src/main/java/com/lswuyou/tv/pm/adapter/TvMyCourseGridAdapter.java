...
public class TvMyCourseGridAdapter extends TvBaseAdapter {
    private List<CourseSimpleInfo> appList;
    private LayoutInflater inflater;
    private Context mContext;

    public TvMyCourseGridAdapter(Context context, List<CourseSimpleInfo> appList) {
    ...
    public View getView(int position, View contentView, ViewGroup parent) {
        ...
        CourseSimpleInfo courseInfo = appList.get(position);
