...
public abstract class DataServiceBase extends AsyncHttpResponseHandler {
    ...
    public DataServiceBase(Context mContext) {
        ...
        if (!isHeaderAdded) {
            ...
            try {
                InputStream inputStream = mContext.getResources().openRawResource(R.raw.ca);
                ...
                KeyManagerFactory keyManagerFactory = KeyManagerFactory.getInstance
                        (KeyManagerFactory
                        .getDefaultAlgorithm());
                InputStream keyStoreStream = mContext.getResources().openRawResource(R.raw.ca);
                ...
                httpClient.setSSLSocketFactory(new SSLSocketFactoryEx(keyStore, keyManagerFactory
                        .getKeyManagers(), jksX509TrustManager));
