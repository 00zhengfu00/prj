...
public final class FileDownloader {
     ...
     */
    @Deprecated
    public static void detect(String url,String videoId, OnDetectUrlFileListener onDetectUrlFileListener) {
        getFileDownloadManager().detect(url,videoId, onDetectUrlFileListener);
    }
     ...
     * @since 0.3.0
     */
    public static void detect(String url, String videoId,OnDetectBigUrlFileListener onDetectBigUrlFileListener) {
        getFileDownloadManager().detect(url, videoId,onDetectBigUrlFileListener);
    }
    ...
    public static void detect(String url, String videoId,OnDetectBigUrlFileListener onDetectBigUrlFileListener,
        ...
        getFileDownloadManager().detect(url, videoId,onDetectBigUrlFileListener, downloadConfiguration);
    }
     ...
     * @param url file url
     */
    public static void start(String url,String videoId) {
        getFileDownloadManager().start(url,videoId);
    }
     ...
     * @since 0.3.2
     */
    public static void start(String url,String videoId, DownloadConfiguration downloadConfiguration) {
        if (downloadConfiguration != null) {
            downloadConfiguration.initNullKeyForUrl(url);
        }
        getFileDownloadManager().start(url,videoId, downloadConfiguration);
    }
     ...
     */
    public static void start(List<String> urls,String videoId) {
        getFileDownloadManager().start(urls,videoId);
    }
     ...
     * @since 0.3.2
     */
    public static void start(List<String> urls, String videoId,DownloadConfiguration downloadConfiguration) {
        if (downloadConfiguration != null) {
            downloadConfiguration.initNullKeyForUrls(urls);
        }
        getFileDownloadManager().start(urls,videoId, downloadConfiguration);
    }
     ...
     * @since 0.3.1
     */
    public static void continueAll(boolean isIncludedErrorDownloads,String videoId) {
        continueAll(isIncludedErrorDownloads, null,videoId);
    }
     ...
     * @since 0.3.2
     */
    public static void continueAll(boolean isIncludedErrorDownloads, DownloadConfiguration downloadConfiguration,String videoId) {
        ...
        start(urls, videoId,downloadConfiguration);
    }
    ...
    public static void reStartAll() {
        getFileDownloadManager().restartAll();
    }
    /**
     * restart a download
     * <br/>
     ...
     * @param url file url
     */
    public static void reStart(String url,String videoId) {
        getFileDownloadManager().reStart(url,videoId);
    }
     ...
     * @since 0.3.2
     */
    public static void reStart(String url, String videoId,final DownloadConfiguration downloadConfiguration) {
        if (downloadConfiguration != null) {
            downloadConfiguration.initNullKeyForUrl(url);
        }
        getFileDownloadManager().reStart(url, videoId,downloadConfiguration);
    }
     ...
     * @param urls file urls
     */
    public static void reStart(List<String> urls,String videoId) {
        getFileDownloadManager().reStart(urls,videoId);
    }
     ...
     * @since 0.3.2
     */
    public void reStart(List<String> urls, String videoId,DownloadConfiguration downloadConfiguration) {
        if (downloadConfiguration != null) {
            downloadConfiguration.initNullKeyForUrls(urls);
        }
        getFileDownloadManager().reStart(urls, videoId,downloadConfiguration);
    }
