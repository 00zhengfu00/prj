...
public abstract class BaseContentDbHelper extends SQLiteOpenHelper {
     ...
     * @email 411086563@qq.com
     */
    public static class DownloadFileInfo extends BaseUrlFileInfo {
        ...
        DownloadFileInfo(DetectUrlFileInfo detectUrlFileInfo) {
            ...
            this.mParentId = detectUrlFileInfo.getParentId();
        }
        ...
        void update(DownloadFileInfo downloadFileInfo) {
            ...
            if (downloadFileInfo.mDownloadedSize > 0 && downloadFileInfo.mDownloadedSize != this
                    .mDownloadedSize) {
            ...
            if (!TextUtils.isEmpty(downloadFileInfo.mParentId)) {
                this.mParentId = downloadFileInfo.mParentId;
            }
        }
