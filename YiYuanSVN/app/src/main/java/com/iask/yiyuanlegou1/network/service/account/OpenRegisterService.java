/* 
 * 系统名称：lswuyou
 * 类  名  称：OpenRegisterService.java
 * 软件版权：无届网络科技有限公司
 * 系统版本：1.0.0
 * 开发人员： huashigen
 * 开发时间： 2015-9-16 上午9:36:33
 * 功能说明： 第三方注册
 * 审核人员：
 * 相关文档
...
public class OpenRegisterService extends OpenApiDataServiceBase {

	public OpenRegisterService(Context pContext) {
		super(pContext);
	}

	@Override
	protected String getResouceURI() {
		return ServiceURL.OPEN_REGISTER;
	}
