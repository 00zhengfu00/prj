...
public class MyShareFragment extends BaseFragment {
    ...
    protected void initView() {
        ...
        manager.registerReceiver(receiver, new IntentFilter(MyUnShareFragment.SHARE_ORDER_REFRESH));
    }
    ...
    private void initListView() {
        ...
        myShareBeans = new ArrayList<MyShareBean>();
        adapter = new MyShareAdapter(myShareBeans, getActivity());
    ...
    private void getData() {
        MyShareService service = new MyShareService(getActivity());
        service.setCallback(new IOpenApiDataServiceCallback<MyShareResponse>() {
            @Override
            public void onGetData(MyShareResponse data) {
                ...
                try {
                    ...
                    if (data.data.myOrderList.size() > 0) {
                        myShareBeans.addAll(data.data.myOrderList);
                        id = myShareBeans.get(myShareBeans.size() - 1).getSdId();
                    } else {
