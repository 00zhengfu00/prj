...
public class RecommendProductAdapter extends BaseAdapter {
    ...
    public RecommendProductAdapter(List<HomePageProductBean> data, Context context) {
        this.data = data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            ...
            convertView = LayoutInflater.from(context).inflate(
                    R.layout.listview_recommend_goods_item1, null);
            convertView.setLayoutParams(new LinearLayout.LayoutParams((int) (ScreenUtils
                    .getScreendensity(context) * 150), ViewGroup.LayoutParams.MATCH_PARENT));
