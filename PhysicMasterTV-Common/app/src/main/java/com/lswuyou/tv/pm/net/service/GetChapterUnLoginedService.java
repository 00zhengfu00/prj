 ...
 */
public class GetChapterUnLoginedService extends OpenApiDataServiceBase {
    public GetChapterUnLoginedService(Context pContext) {
        super(pContext);
    }

    @Override
    protected String getResouceURI() {
        return ServiceURL.GET_CHAPTER_DETAIL_UNLOGIN;
    }
