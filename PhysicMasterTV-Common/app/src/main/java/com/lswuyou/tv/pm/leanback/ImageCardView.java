...
public class ImageCardView extends BaseCardView {
    ...
    public void setMainImageDimensions(int width, int height) {
        BaseCardView.LayoutParams lp = (BaseCardView.LayoutParams) mImageView.getLayoutParams();
        lp.width = width;
        lp.height = height;
    ...
    /**
     * set the contentView backgroundcolor
     *
     * @param color
     */
    ...
    /**
     * set the contentView visibility
     *
     * @param viewVisible
     */
    public void setContentViewVisible(int viewVisible) {
        mContentView.setVisibility(viewVisible);
    }
