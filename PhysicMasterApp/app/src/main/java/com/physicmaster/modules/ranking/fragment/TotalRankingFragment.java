...
public class TotalRankingFragment extends BaseFragment2 {
    ...
    protected void initView(View view) {
        ...
        total = bundle.getParcelable("total");
        week = bundle.getParcelable("week");
        upDataUI();
    }
    ...
    public void upDataUI() {
        ...
        mViewPager.setAdapter(new RankingAdapter(getChildFragmentManager()));
            ...
            if (fragment == null) {
                switch (position) {
                    case 0:
                        ...
                        bundle1.putParcelable("bean", week);
                        fragment.setArguments(bundle1);
                        break;
                    case 1:
                        fragment = new WeekRankingFragment();
                        Bundle bundle2 = new Bundle();
                        bundle2.putParcelable("bean", total);
