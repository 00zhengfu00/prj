...
import com.physicmaster.modules.mine.activity.topicmap.OnTopicmapAnswerSubmmit;
import com.physicmaster.modules.mine.activity.topicmap.TopicmapExerciseActivity;
...
public class TopicmapExcerciseFragment extends BaseFragment implements View.OnClickListener {
    ...
    private TopicmapExerciseActivity mContext;

    private OnTopicmapAnswerSubmmit onAnswerSubmmitListener;
    ...
    private GetTopicmapAnalysisResponse.DataBean.QuestionWrongListBean exercise;

    public OnTopicmapAnswerSubmmit getOnAnswerSubmmitListener() {
        return onAnswerSubmmitListener;
    }

    public void setOnAnswerSubmmitListener(OnTopicmapAnswerSubmmit onAnswerSubmmitListener) {
    ...
    protected void initView() {
        ...
        mContext = (TopicmapExerciseActivity) getActivity();
    ...
    private void setdata() {
        ...
        exercise = (GetTopicmapAnalysisResponse.DataBean.QuestionWrongListBean) bundle.getSerializable("exercise");
    ...
    public void click() {
        ...
        btnResolve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                onAnswerSubmmitListener.submmit(questionid, selecterAnswer,exercise.wrongId,right);
            }
        });
    }
}
