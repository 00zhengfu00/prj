 ...
 */
package com.tt.lvruheng.eyepetizer.common.cache;
...
public class CacheManager {
     ...
     * 处理账户私密数据
     */
    private static ACache userInfoCache = ACache.get(BaseApplication.Companion.getContext(),
            accountDataDirectory);
    /**
     * 处理账户公用数据
     */
    private static ACache publicDataCache = ACache.get(BaseApplication.Companion.getContext(),
            publicDataDirectory);
    /**
     * 处理账户相关数据
     */
...
//    }
    ...
    public static void saveString(int type, String key, String value) {
        ...
        try {
            ...
            UIUtils.showToast(BaseApplication.Companion.getContext(), "您的手机存储不足，已影响本软件的正常使用，请清理后再试~");
        }
    }
