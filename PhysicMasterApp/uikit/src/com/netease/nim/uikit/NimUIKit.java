...
public final class NimUIKit {
     ...
     * {@link NimUIKit#init(Context, UserInfoProvider, ContactProvider)}
     *
     * @param context
     */
     ...
     */
    public static void init(Context context, UserInfoProvider userInfoProvider, ContactProvider
            contactProvider) {
     ...
     * ，请使用{@link NimUIKit#startChatting(Context, String, SessionTypeEnum, SessionCustomization, IMMessage)}
     *
     * @param context 上下文
     * @param account 目标账号
     */
    ...
    public static void startP2PSession(Context context, String account, IMMessage anchor) {
        NimUIKit.startChatting(context, account, SessionTypeEnum.P2P,
                commonP2PSessionCustomization, anchor);
    }
    ...
    public static void startTeamSession(Context context, String tid, IMMessage anchor) {
        NimUIKit.startChatting(context, tid, SessionTypeEnum.Team,
                commonTeamSessionCustomization, anchor);
    }
     ...
     */
    public static AbortableFuture<LoginInfo> doLogin(LoginInfo loginInfo, final
     ...
     * @param anchor        跳转到指定消息的位置，不需要跳转填null
     */
    public static void startChatting(Context context, String id, SessionTypeEnum sessionType,
     ...
     */
    public static void startContactSelect(Context context, ContactSelectActivity.Option option,
                                          int requestCode) {
     ...
     */
    public static void setCommonP2PSessionCustomization(SessionCustomization
     ...
     */
    public static void setCommonTeamSessionCustomization(SessionCustomization
     ...
     */
    public static void registerMsgItemViewHolder(Class<? extends MsgAttachment> attach, Class<?
            extends MsgViewHolderBase> viewHolder) {
    ...
    public static void setOnlineStateContentProvider(OnlineStateContentProvider
                                                             onlineStateContentProvider) {
        NimUIKit.onlineStateContentProvider = onlineStateContentProvider;
    }

    public static void addOnlineStateChangeListeners(OnlineStateChangeListener
    ...
    public static void removeOnlineStateChangeListeners(OnlineStateChangeListener
                                                                onlineStateChangeListener) {
        if (onlineStateChangeListeners == null) {
            return;
        }
