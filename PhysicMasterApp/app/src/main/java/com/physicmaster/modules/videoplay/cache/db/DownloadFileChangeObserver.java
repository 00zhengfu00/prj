...
class DownloadFileChangeObserver implements OnDownloadFileChangeListener {
     ...
     */
    private void notifyDownloadFileCreated(BaseContentDbHelper.DownloadFileInfo downloadFileInfo, OnDownloadFileChangeListener listener,
                                           boolean sync) {
        // notify caller
        if (sync) {
            // sync notify caller
            ...
            MainThreadHelper.onDownloadFileCreated(downloadFileInfo, listener);
        }
     ...
     */
    private void notifyDownloadFileUpdated(BaseContentDbHelper.DownloadFileInfo downloadFileInfo, Type type, OnDownloadFileChangeListener
        ...
        if (sync) {
            ...
            // main thread notify caller
            MainThreadHelper.onDownloadFileUpdated(downloadFileInfo, type, listener);
        }
     ...
     */
    private void notifyDownloadFileDeleted(BaseContentDbHelper.DownloadFileInfo downloadFileInfo, OnDownloadFileChangeListener listener,
                                           boolean sync) {
        // notify caller
        if (sync) {
            // sync notify caller
            ...
            // main thread caller
            MainThreadHelper.onDownloadFileDeleted(downloadFileInfo, listener);
        }
        String url = downloadFileInfo != null ? downloadFileInfo.getUrl() : "unknown";
    ...
    @Override
    public void onDownloadFileCreated(BaseContentDbHelper.DownloadFileInfo downloadFileInfo) {
    ...
    @Override
    public void onDownloadFileUpdated(BaseContentDbHelper.DownloadFileInfo downloadFileInfo, Type type) {
    ...
    @Override
    public void onDownloadFileDeleted(BaseContentDbHelper.DownloadFileInfo downloadFileInfo) {
