...
import static com.netease.nim.uikit.uinfo.UserInfoHelper.getUserTitleName;
...
public class P2PMessageActivity extends BaseMessageActivity {
    ...
    public static void start(Context context, String contactId, SessionCustomization
            customization, IMMessage anchor) {
        Intent intent = new Intent();
        extra = contactId;
        JSONObject jsonObject = JSON.parseObject(contactId);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.title_left_imageview).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
        });
        findViewById(R.id.title_left_textview).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
    ...
    private void requestBuddyInfo() {
        String name = UserInfoHelper.getUserTitleName(sessionId, SessionTypeEnum.P2P);
        if (sessionId == null || name == null || sessionId.equals(name)) {
    ...
    FriendDataCache.FriendDataChangedObserver friendDataChangedObserver = new FriendDataCache
        ...
        public void onAddedOrUpdatedFriends(List<String> accounts) {
            setTitle(getUserTitleName(sessionId, SessionTypeEnum.P2P));
        }
    ...
    protected void showCommandMessage(CustomNotification message) {
        ...
        try {
            ...
            if (id == 1) {
                ...
                Toast.makeText(P2PMessageActivity.this, "command: " + content, Toast
                        .LENGTH_SHORT).show();
            }
    ...
    public void setTitle(CharSequence title) {
        ...
        TextView tvTitle = (TextView) findViewById(R.id.title_middle_textview);
        if (TextUtils.isEmpty(title) || title.equals(sessionId)) {
