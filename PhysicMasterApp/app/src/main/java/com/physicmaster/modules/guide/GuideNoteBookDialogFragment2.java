...
public class GuideNoteBookDialogFragment2 {

    private PaintViewNoteBook2 paintView;
    private FrameLayout mParentView;
    private final View rootView;

    public GuideNoteBookDialogFragment2(Activity activity, Bundle bundle) {
        mParentView = (FrameLayout) activity.getWindow().getDecorView();
        rootView = activity.getLayoutInflater().inflate(R.layout.dialogfragment_guide_notebook2, mParentView, false);
