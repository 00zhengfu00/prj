...
import com.tt.lvruheng.eyepetizer.network.service.ResetPwdService
...
class ResetPwdActivity : BaseActivity() {
    ...
    override fun initView() {
        ...
        btnNext.setOnClickListener({
            ...
            val resetPwdService = ResetPwdService(this)
            resetPwdService.callback = object : IOpenApiDataServiceCallback<ChangePwdResponse> {
            ...
            resetPwdService.postLogined("mobileNo=${mobileNum}&passwd=${passwd}&verifyCode=${verifyCode}", true)
        })
