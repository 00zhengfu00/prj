...
public class RoundImageView extends ImageView {
	...
	protected void onDraw(Canvas canvas) {
		...
		Bitmap roundBitmap = getCroppedRoundBitmap(bitmap, radius - mBorderThickness);

		canvas.drawBitmap(roundBitmap, defaultWidth / 2 - radius + mBorderThickness, defaultHeight / 2 - radius + mBorderThickness, null);
