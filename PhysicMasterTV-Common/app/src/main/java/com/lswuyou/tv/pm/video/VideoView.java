...
package com.lswuyou.tv.pm.video;
...
public class VideoView extends SurfaceView implements
    ...
    public static final int VIDEO_LAYOUT_CONTAINER = 4;
    ...
    private static final int mDefaultSpeed = 5000;
    ...
    public void setVideoLayout(int layout) {
        ...
        if (mVideoHeight > 0 && mVideoWidth > 0) {
            ...
            } else if (layout == VIDEO_LAYOUT_CONTAINER) {
            } else {
    ...
    private void openVideo() {
        ...
        try {
            ...
            if (mUri != null) {
                ...
                ijkMediaPlayer.setOption(IjkMediaPlayer.OPT_CATEGORY_FORMAT, "user_agent",
                        mUserAgent);
    ...
    private OnErrorListener mErrorListener = new OnErrorListener() {
        public boolean onError(IMediaPlayer mp, int framework_err, int impl_err) {
            ...
            if (getWindowToken() != null) {
                int message = framework_err == IMediaPlayer
                        .MEDIA_ERROR_NOT_VALID_FOR_PROGRESSIVE_PLAYBACK ? R.string
                        .vitamio_videoview_error_text_invalid_progressive_playback
...
//                    mMediaController.show();
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_DPAD_LEFT) {
            ...
            mMediaPlayer.start();
            mMediaController.setSeeking(false);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (isInPlaybackState() && isKeyCodeSupported && mMediaController != null) {
            if (keyCode == KeyEvent.KEYCODE_HEADSETHOOK || keyCode == KeyEvent
                    .KEYCODE_MEDIA_PLAY_PAUSE || keyCode == KeyEvent.KEYCODE_SPACE) {
                ...
                return true;
            } else if (keyCode == KeyEvent.KEYCODE_MEDIA_STOP || keyCode == KeyEvent
                    .KEYCODE_MEDIA_PAUSE) {
                if (mMediaPlayer.isPlaying()) {
                    pause();
                    mMediaController.show();
                ...
                if (lastSavedTime > 0) {
                    if (currentTime - lastSavedTime > 300) {
                        currentPosition = getCurrentPosition() - mDefaultSpeed;
                    } else {
                        currentPosition -= mDefaultSpeed;
                    }
                } else {
                    currentPosition = getCurrentPosition() - mDefaultSpeed;
                }
                ...
                mMediaController.updateProgress(progress, currentPosition);
                mMediaController.setSeeking(true);
            } else if (keyCode == KeyEvent.KEYCODE_DPAD_RIGHT) {
                mMediaPlayer.pause();
                mMediaController.show();
                long currentTime = System.currentTimeMillis();
                ...
                mMediaController.updateProgress(progress, currentPosition);
                mMediaController.setSeeking(true);
            } else if (keyCode == KeyEvent.KEYCODE_ENTER || keyCode == KeyEvent
                    .KEYCODE_DPAD_CENTER) {
                if (mMediaPlayer.isPlaying()) {
                    pause();
                    mMediaController.show();
    ...
    public void seekTo(long msec) {
        Log.e("VideoView", "拖动到：" + msec / 1000 + "秒");
        if (isInPlaybackState()) {
            if (mMediaController != null) {
