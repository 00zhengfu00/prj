package com.physicmaster.modules.discuss.event;
...
import com.physicmaster.modules.discuss.common.infra.Handlers;
...
public class OnlineStateEventSubscribe {
    ...
    public static void initSubscribes() {
        ...
        if (timeInterval <= SUBS_FREQ) {
            ...
            LogUtil.ui("time interval short than 30 and initData subscribe delay " + delay);
